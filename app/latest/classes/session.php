...
abstract class Session {
	 ...
	 */
	public static $default = 'cookie'; // Default work with a Cookie! That way, logins get remembered for a longer time, which is currently great. TODO: give user more fine-grained control over login etc.
