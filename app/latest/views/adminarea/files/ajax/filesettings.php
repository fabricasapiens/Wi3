...
<?php 
    ...
    try 
    {
        ...
        echo "<p><label for='title'>titel: </label><input name='title' id='title' type='text' value='" . $file->title . "' /></p>";
    ...
    //opslaan knop
    echo " <button onClick='wi3.request(\"adminarea_files_ajax/editFileSettings/\" + $(\"#wi3_edited_file\").html(), $(\"#wi3_fileedit_form\").serializeArray());'>opslaan</button>";
