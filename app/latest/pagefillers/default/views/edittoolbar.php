<div id='pagefiller_default_edittoolbar'">
    <div id='pagefiller_default_edittoolbar_content' style='position: relative; left: 50%; margin-left: -480px; width: 960px;'>
        ...
        <div id='pagefiller_default_edittoolbar_formatblockpanel' onMouseOver='wi3.pagefillers.default.edittoolbar.showFormatblockPanel();' onMouseOut='wi3.pagefillers.default.edittoolbar.hideFormatblockPanel();' style='display: none; position: absolute; z-index: 10; left: 200px; width: 200px; padding: 10px; overflow: auto; background: #fff; border: 1px solid #ddd; border-top: none;'>
