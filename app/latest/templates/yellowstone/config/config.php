<?php
    ...
    (
        "version" => "1.0",
        "templateview" => Wi3::inst()->pathof->app."/templates/yellowstone/template.php",
        "dropzones" => Array("main"),
        "preview" => Array(
            "imageurl" => Wi3::inst()->urlof->appfiles."templates/yellowstone/static/images/previewimage.png",
            "dropzones" => Array
            (
                "main" => Array 
                (
